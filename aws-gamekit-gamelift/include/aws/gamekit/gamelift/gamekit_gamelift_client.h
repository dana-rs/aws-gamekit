...
namespace GameKit
{
    namespace GameLift
    {
        enum class GameLiftOperationType
        {
        ...
        struct GAMEKIT_API GameLiftOperation : public IOperation
        {
            GameLiftOperation(GameLiftOperationType type, const std::string& bundle, const std::string& item,
            ...
            const GameLiftOperationType Type;
            ...
            static bool TrySerializeBinary(std::ostream& os, const std::shared_ptr<GameLiftOperation> operation, FuncLogCallback logCb = nullptr);
            static bool TryDeserializeBinary(std::istream& is, std::shared_ptr<IOperation>& outOperation, FuncLogCallback logCb = nullptr);
            static bool TryDeserializeBinary(std::istream& is, std::shared_ptr<GameLiftOperation>& outOperation, FuncLogCallback logCb = nullptr);
        };
        ...
        class GAMEKIT_API GameLiftHttpClient : public BaseHttpClient
        {
        private:
        ...
        public:
            GameLiftHttpClient(std::shared_ptr<Aws::Http::HttpClient> client, RequestModifier authSetter,
                unsigned int retryIntervalSeconds, std::shared_ptr<IRetryStrategy> retryStrategy, size_t maxQueueSize, FuncLogCallback logCb) : 
                BaseHttpClient("GameLift", client, authSetter, retryIntervalSeconds, retryStrategy, maxQueueSize, logCb)
            {}

            virtual ~GameLiftHttpClient() override {}

            RequestResult MakeRequest(GameLiftOperationType operationType, bool isAsync, const char* bundle, const char* itemKey, std::shared_ptr<Aws::Http::HttpRequest> request,
